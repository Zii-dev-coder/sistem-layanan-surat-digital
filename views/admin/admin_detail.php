...
$baseURL = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") 
           . "://{$_SERVER['HTTP_HOST']}/ProjectW/uploads/";
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<div class="detail-page">
    ...
    <main class="detail-grid">
            ...
            <div class="info-list">
                ...
                <div class="info-row">
                    ...
                    <span class="value multiline">
                        <?= $permohonan['keterangan'] !== '' ? nl2br(htmlspecialchars($permohonan['keterangan'])) : '-' ?>
                    </span>
                </div>

                <?php if (!empty($permohonan['file_pdf'])): ?>
                <div class="info-row">
                    <span class="label">Lampiran PDF</span>
                    <span class="value">
                        <a href="uploads/<?= urlencode($permohonan['file_pdf']) ?>" target="_blank" class="link-file">
                            <i class="fas fa-file-pdf"></i> Lihat / Download
                        </a>
                    </span>
                </div>
                <?php endif; ?>
                ...
                <div class="info-row">
                    ...
                    <span class="value">
                        <a href="uploads/<?= urlencode($permohonan['file_user']) ?>" target="_blank" class="link-file">
                            <i class="fas fa-file"></i> Lihat / Download
                        </a> | 
                        <a href="https://docs.google.com/gview?url=<?= urlencode($baseURL . $permohonan['file_user']) ?>&embedded=true" target="_blank" class="link-file">
        ...
        <section class="card card-actions">
            ...
            <p class="hint">
                Pastikan data sudah diperiksa sebelum menyetujui atau menolak permohonan.
            </p>
        </section>
    </main>
</div>
